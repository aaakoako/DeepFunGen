...
const translations = {
    ...
    en: {
        ...
        'add.recommend_parameters': 'Smart Recommend',
        'add.recommend_analyzing': 'Analyzing...',
        'add.recommend_success': 'Parameter recommendation completed',
        'add.recommend_failed': 'Recommendation failed: No valid response received',
        'add.recommend_failed_error': 'Recommendation failed',
        'add.recommend_no_video': 'Please stage at least one video first.',
        'add.recommend_no_model': 'Please select a model first.',
        'add.recommend_value': 'Recommended',
        'add.apply_recommend': 'Apply',
        'add.apply_all_recommend': 'Apply All',
        'add.applied_value': 'Applied recommended value',
        'add.applied_all_values': 'Applied {count} recommended values',
        'add.no_recommendations': 'No recommendations available',
    },
    zh: {
        'app.title': 'DeepFunGen',
        ...
        'status.cpu': 'CPU',
        'status.queue': '队列',
        'status.provider': '执行引擎',
        'add.title': '添加文件',
        'add.subtitle': '暂存视频，配置选项，并将任务加入队列。',
        'add.model_label': '模型',
        'add.model_vr_only': 'VR 模型',
        'add.no_models_vr': '没有可用的 VR 模型。',
        'add.no_models_non_vr': '没有可用的非 VR 模型。',
        'add.drop_message': '将视频拖放到此处',
        'add.browse_files': '浏览文件',
        'add.browse_folder': '浏览文件夹',
        'add.manual_path_label': '输入绝对路径',
        'add.manual_path_button': '添加路径',
        'add.manual_path_hint': '当文件对话框无法显示原始路径时使用此功能。',
        'add.staged_title': '已暂存项',
        'add.options_title': '处理选项',
        'add.opt_smooth': '平滑窗口',
        'add.opt_prominence': '突出度比率',
        'add.opt_min_prominence': '最小突出度',
        'add.opt_max_slope': '最大斜率',
        'add.opt_boost_slope': '增强斜率',
        'add.opt_min_slope': '最小斜率',
        'add.opt_merge': '合并阈值',
        'add.opt_fft_denoise': 'FFT 降噪',
        'add.opt_fft_frames': 'FFT 帧数 / 分量',
        'add.opt_fft_window': 'FFT 窗口帧数',
        'add.recommend_parameters': '智能推荐',
        'add.recommend_analyzing': '分析中...',
        'add.recommend_success': '参数推荐完成',
        'add.recommend_failed': '推荐失败：未收到有效响应',
        'add.recommend_failed_error': '推荐失败',
        'add.recommend_no_video': '请先暂存至少一个视频。',
        'add.recommend_no_model': '请先选择模型。',
        'add.recommend_value': '推荐',
        'add.apply_recommend': '应用',
        'add.apply_all_recommend': '一键应用',
        'add.applied_value': '已应用推荐值',
        'add.applied_all_values': '已应用 {count} 个推荐值',
        'add.no_recommendations': '没有可用的推荐值',
        'add.tooltip.smooth': '平滑原始信号时使用的移动平均帧数。',
        'add.tooltip.prominence': '相对于局部范围的最小峰值突出度比率 (0–1)。',
        'add.tooltip.min_prominence': '平滑后峰值保持所需突出度的绝对最小值。',
        'add.tooltip.max_slope': '丢弃斜率大于此值的过渡段。',
        'add.tooltip.boost_slope': '将斜率放大到此值以强调细微运动。',
        'add.tooltip.min_slope': '忽略低于此值的斜率以抑制噪声。',
        'add.tooltip.merge': '合并间隔小于此值（毫秒）的相邻事件。',
        'add.tooltip.fft_denoise': '在检测峰值之前应用基于 FFT 的降噪。',
        'add.tooltip.fft_frames': '执行降噪时每个 FFT 分量的帧数。',
        'add.tooltip.fft_window': '覆盖 FFT 窗口大小（留空为自动）。',
        'add.toast_unsupported': '不支持的文件类型。',
        'add.toast_drop_failed': '当前环境不支持拖放功能。',
        'add.toast_drop_skipped': '没有新文件被暂存。',
        'add.toast_browser_no_path': '浏览器无法访问文件路径。请使用桌面应用程序。',
        'add.toast_enter_path': '请先输入文件路径。',
        'queue.no_staged': '没有已暂存的文件。',
        'queue.enqueue': '加入队列',
        'queue.remove': '移除',
        'queue.cancel': '取消',
        'queue.opt_smooth': '平滑窗口',
        'queue.opt_prominence': '突出度比率',
        'queue.opt_merge': '合并阈值 (ms)',
        'queue.opt_recursive': '包含子文件夹',
        'queue.active_title': '处理队列',
        'queue.subtitle': '跟踪排队、运行和已完成的任务。',
        'queue.refresh': '刷新',
        'queue.clear_finished': '清除已完成',
        'queue.table.video': '视频',
        'queue.table.status': '状态',
        'queue.table.progress': '进度',
        'queue.table.stats': '状态/进度',
        'queue.table.model': '模型',
        'queue.table.options': '选项',
        'queue.table.actions': '操作',
        'queue.empty': '队列为空。',
        'queue.toast_added': '已将 {count} 个文件加入队列。',
        'queue.toast_skipped': '所有文件均被跳过。',
        'queue.toast_cancelled': '任务已取消。',
        'queue.toast_cleared': '已完成的任务已清除。',
        'queue.toast_select': '请至少选择一个视频。',
        'queue.toast_dialog': '原生对话框不可用。',
        'queue.open_viewer': '打开查看器',
        'queue.open_csv': '打开 CSV',
        'queue.open_folder': '打开文件夹',
        'queue.no_csv': '预测 CSV 尚未生成。',
        'queue.no_folder': '没有可打开的文件夹。',
        'queue.stats.pre': '预处理',
        'queue.stats.infer': '推理',
        'queue.stats.eta': '预计',
        'queue.stats.elapsed': '已用',
        ...
        'viewer.model': '模型',
        'viewer.no_data': '选择一个已完成的任务以可视化预测。',
        'viewer.plot_placeholder': '图表渲染即将推出。',
        'viewer.cursor_time': '时间',
        'viewer.cursor_value': '值',
        'viewer.window_label': '窗口范围',
        'viewer.preview_hint': '将鼠标悬停在图表上以预览帧。',
        'viewer.current_value': '当前值',
        'viewer.options_heading': '处理选项',
        'viewer.options_apply': '应用',
        'viewer.options_fft_window_placeholder': '自动',
        'viewer.options_status_select': '请先选择一个已完成的任务。',
        'viewer.options_status_busy': '正在更新选项…',
        'viewer.options_status_unavailable': '等待处理完成后再更新选项。',
        'viewer.options_status_applied': '选项已更新。',
        'viewer.options_status_error': '更新选项失败。',
        'viewer.options_toast_nochange': '未检测到选项更改。',
        'viewer.options_toast_applied': '选项已更新。',
        'viewer.options_toast_invalid': '无法收集选项。',
        'viewer.no_options': '没有后处理选项。',
        'viewer.auto': '自动',
        'viewer.boolean_on': '开启',
        'viewer.boolean_off': '关闭',
        'viewer.back_to_queue': '返回队列',
        'logs.title': '实时日志',
        'logs.show_info': '信息',
        'logs.show_warning': '警告',
        'logs.show_error': '错误',
        ...
        'settings.postprocess_header': '后处理选项',
        'settings.save': '保存设置',
        'settings.autosave_hint': '更改会自动保存。',
        'license.title': '开源许可证',
        'license.subtitle': '此应用程序包含以下第三方软件。',
        'license.license_label': '许可证',
        'license.loading': '正在加载许可证信息...',
        'license.none': '没有可用的第三方通知。',
        'settings.updates': '更新',
        'settings.current_version': '当前版本',
        'settings.check_updates': '检查更新',
        'settings.smooth_window': '平滑窗口',
        'settings.prominence_ratio': '突出度比率',
        'settings.merge_threshold': '合并阈值',
        'common.path_copied': '路径已复制到剪贴板。',
        'param.explanation.title': '参数说明',
        'param.explanation.smooth_window': '平滑窗口：控制信号平滑程度，值越大funscript动作越平滑，但可能丢失细节。',
        'param.explanation.prominence_ratio': '突出度比率：过滤小幅度波动，值越大funscript动作越少，但精度更高。',
        'param.explanation.min_prominence': '最小突出度：峰值必须达到的最小值，值越大过滤的峰值越多。',
        'param.explanation.max_slope': '最大斜率：限制动作变化速度，值越大允许更快的动作变化。',
        'param.explanation.boost_slope': '增强斜率：放大细微运动，值越大细微动作越明显。',
        'param.explanation.min_slope': '最小斜率：过滤噪声，值越大过滤的细微变化越多。',
        'param.explanation.merge_threshold': '合并阈值：合并相邻动作的时间间隔，值越大动作越少但可能延迟。',
        'param.explanation.fft_denoise': 'FFT降噪：使用频域降噪，可以去除高频噪声，使funscript更平滑。',
        'param.explanation.fft_frames': 'FFT帧数：每个频率分量的帧数，影响降噪效果和细节保留。',
        'param.recommendation.title': '推荐理由',
        'param.recommendation.reasoning': '推荐理由',
        'param.recommendation.show_details': '查看详情',
        'param.recommendation.hide_details': '隐藏详情',
        'param.recommendation.no_reasoning': '暂无推荐理由',
    },
};
