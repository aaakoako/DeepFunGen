...
const translations = {
    zh: {
        ...
        'queue.options.smooth': '平滑',
        'queue.options.prom': '突出',
        'queue.options.merge': '合并',
        'queue.options.fft': 'FFT',
        'queue.options.on': '开',
        'queue.options.off': '关',
        'viewer.model': '模型',
        'viewer.no_data': '请选择一个已完成的任务以可视化预测结果。',
        ...
        'settings.save': '保存设置',
        'settings.autosave_hint': '更改将自动保存。',
        'license.title': '开源许可证',
        'license.subtitle': '本应用程序包含以下第三方软件。',
        'license.license_label': '许可证',
        'license.loading': '正在加载许可证信息...',
        'license.none': '没有可用的第三方声明。',
        'settings.updates': '更新',
    ...
    ko: {
        ...
        'add.recommend_parameters': '스마트 추천',
        'add.recommend_analyzing': '분석 중...',
        'add.recommend_success': '매개변수 추천 완료',
        'add.recommend_failed': '추천 실패: 유효한 응답을 받지 못했습니다',
        'add.recommend_failed_error': '추천 실패',
        'add.recommend_no_video': '먼저 최소 하나의 영상을 스테이징하세요.',
        'add.recommend_no_model': '먼저 모델을 선택하세요.',
        'add.recommend_value': '추천',
        'add.apply_recommend': '적용',
        'add.apply_all_recommend': '일괄 적용',
        'add.applied_value': '추천 값 적용됨',
        'add.applied_all_values': '{count}개 추천 값 적용됨',
        'add.no_recommendations': '사용 가능한 추천 값이 없습니다',
        ...
        'add.toast_enter_path': '먼저 파일 경로를 입력하세요.',
        ...
        'queue.options.smooth': '스무딩',
        'queue.options.prom': '프로미넌스',
        'queue.options.merge': '병합',
        'queue.options.fft': 'FFT',
        'queue.options.on': '켜짐',
        'queue.options.off': '꺼짐',
        'viewer.model': '모델',
    ...
    en: {
        ...
        'add.toast_enter_path': 'Enter a file path first.',
        ...
        'queue.options.smooth': 'Smooth',
        'queue.options.prom': 'Prom',
        'queue.options.merge': 'Merge',
        'queue.options.fft': 'FFT',
        'queue.options.on': 'on',
        'queue.options.off': 'off',
        'viewer.model': 'Model',
